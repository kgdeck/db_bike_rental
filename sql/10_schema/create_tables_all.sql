...
ALTER TABLE EMP ADD CONSTRAINT FK_EMP_ADDRESS FOREIGN KEY (ADDRESS) REFERENCES ADDRESS(ID);
...
ALTER TABLE RENTAL ADD CONSTRAINT FK_RENTAL_RESPONSIBLE FOREIGN KEY (RESPONSIBLE) REFERENCES EMP(ID);
...
ALTER TABLE DAMAGE ADD CONSTRAINT FK_DAMAGE_RESPONSIBLE FOREIGN KEY (RESPONSIBLE) REFERENCES EMP(ID);
